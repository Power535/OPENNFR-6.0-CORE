...
do_install() {
    ...
    for f in mp_pluginliste bouquets* userbouquet* autotimer.xml cert.pem key.pem lamedb menusort.xml pluginsort.xml settings subservices.xml lcndb epgimport.conf
    do
